...
class RecordBook{
	...
	init() {
		...
		records.append( Record(date: entryDate("2001/11/7 09:11"),  name:"Який смисл?"  , text: "Жизнь боль......",weather: Weather.storm ))
		...
		records.append( Record(date: entryDate("2016/09/14 18:59"), name:"ХЗ"           , text: "Бути чи не бути, ось в чому питання",weather: Weather.snow))
		records.append( Record(date: entryDate("2016/10/1 10:00"),  name:"Камтугеза"	, text: "Барбара Стрейнз ууууу-ууу--уууу---ууу--ууууууууу",weather: Weather.sun))
		records.append( Record(date: entryDate("2016/09/14 18:59"), name:"Куку"			, text: "Хто там?",weather: Weather.sun))
